...
% Font size controls (if you change these, you will probably
% have to change various spacing parameters as well):
FontSizeInstructions = 10;
FontSizeQuestions = 10;
FontSizeRadioButton = 10;
FontSizeNextBackDoneButtons = 10;
FontSizePageNum = 10;
FontSizeWarning = 10;
...
WindowHandle = figure('MenuBar','None','NumberTitle','off','name',WindowTitle, ...
    'Position',[WindowLowerLeftX, WindowLowerLeftY, WindowWidth, WindowHeight]);
...
InstructionHandle = uicontrol(WindowHandle,'Style','text','String',sprintf(InstructionsText), ...
    'HorizontalAlignment','left','FontSize',FontSizeInstructions, ...
...
axeshandle = axes('Position',[0.01 0.01 0.99 0.99],'Visible','off');
...
Shared.ButtonBack = uicontrol('Position', [ButtonX ButtonY ButtonWidth ButtonHeight], 'String',ButtonBackStr, ...
    'Callback', @myBack, 'Visible','off','FontSize',FontSizeNextBackDoneButtons);
...
Shared.ButtonNext = uicontrol('Position', [ButtonX ButtonY ButtonWidth ButtonHeight], 'String',ButtonNextStr, ...
    'Callback', @myNext, 'Visible','off','FontSize',FontSizeNextBackDoneButtons);
Shared.ButtonDone = uicontrol('Position', [ButtonX ButtonY ButtonWidth ButtonHeight], 'String',ButtonDoneStr, ...
    'Callback', 'uiresume(gcbf)', 'Visible','off','FontSize',FontSizeNextBackDoneButtons);

if Shared.NPages > 1
    Shared.PageNumberHandle = uicontrol(WindowHandle,'Style','text','String','page X of Y', ...
        'FontSize',FontSizePageNum,'HorizontalAlignment','center', ...
...
AnswerAllHandle = uicontrol(WindowHandle,'Style','text','String','Please answer all questions!', ...
    'FontSize',FontSizeWarning,'ForegroundColor',red, ...
